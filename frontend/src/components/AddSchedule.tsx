        ...
        <div className="schedule-container">
            <div className="schedule-card">
                ...
                <div className="schedule-content">
                    {message.type && (
                        <div
                            className={`message-alert ${message.type === "success" ? "message-success" : "message-error"
                                }`}
                        >
                            ...
                            <p
                                className={`message-text ${message.type === "success"
                        ...
                        {fileInputs.map((input) => (
                            <div key={input.key} className="file-input-wrapper">
                                ...
                                <div className="file-input-container">
                                    ...
                                    <label
                                        htmlFor={input.key}
                                        className={`file-input-button ${input.file ? "file-input-button-active" : ""
                                    ...
                                    >
                                        <div className="file-input-content">
                                            ...
                                            <span
                                                className={`file-input-text ${input.file
                    ...
                    <div className="action-buttons">
                        ...
                        >
                            {loading ? (
                                <>
                                    <Loader2 className="button-icon button-spinner btn-primary" />
                                    Processing...
                                </>
                            ) : (
                                <>
